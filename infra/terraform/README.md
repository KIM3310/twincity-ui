...
-var='invoker_members=["group:ops-architecture@example.com"]'
...
- When `allow_unauthenticated=false`, add explicit `invoker_members` for architecture or platform groups.
