...
const CONTROL_TOWER_EVIDENCE: ServiceArtifact[] = [
  {
    ...
    kind: "route",
    note: "front-door route chooser for operator proof order",
  },
  {
    label: "Health API",
    href: "/api/health",
  ...
  },
  {
    ...
    kind: "route",
    note: "incident report contract for operators",
  },
  {
    label: "Reports View",
    href: "/reports",
  ...
  },
  {
    ...
    kind: "route",
    note: "attention / dispatch / resolved queue snapshot for operators",
  },
  {
    label: "Assignment History API",
    href: "/api/reports/assignment-history",
    kind: "route",
    note: "operator ownership and handoff chain for operator-safe shift transfer",
  },
  {
