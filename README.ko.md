...
## 기술 스택 신호
- **Next.js / TypeScript:** provider payload를 하나의 운영 계약으로 정규화합니다.
- **Runtime API:** UI 전에 ingest posture와 SLA snapshot을 확인할 수 있습니다.
- **운영 워크플로:** dispatch, handoff, export, 문서가 한 흐름으로 이어집니다.
- **신뢰성 설계:** demo 모드를 숨기지 않고 런타임 경계로 명시합니다.
