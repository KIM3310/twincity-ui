# Service Growth Model - twincity-ui
...
| Field | Decision |
|---|---|
| Service type | Digital twin UI proof |
| Primary reader or buyer | Manufacturing/facility teams only when tied to real operations workflow. |
| Wedge | Visual workflow reuse inside manufacturing or civic operations pilot. |
